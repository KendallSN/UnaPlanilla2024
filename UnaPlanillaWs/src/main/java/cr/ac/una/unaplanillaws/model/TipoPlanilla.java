...
@NamedQueries({
    ...
    ,@NamedQuery(name = "TipoPlanilla.findByCodigoDescripcionPlaxmes", query = "SELECT t FROM TipoPlanilla t WHERE UPPER(t.codigo) like :codigo and UPPER(t.descripcion) like :descripcion and UPPER(t.planillaPorMes) like :plaxmes")
